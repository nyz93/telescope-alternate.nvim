...
require('telescope-alternate').setup({
    ...
    open_only_one_with = 'current_pane', -- when just have only possible file, open it with.  Can also be horizontal_split and vertical_split, or can be set to never to always show the selector
